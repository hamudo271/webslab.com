...
export const COMMERCIAL_METADATA = {
  ...
  '/service': {
    ...
    description:
      '기업 홈페이지 제작, 리뉴얼, SEO 보존 마이그레이션, CMS 구축과 유지보수를 한 팀에서 제공합니다.',
  },
  '/portfolio': {
    path: '/portfolio',
    ...
    description:
      '제조·물류·IT·바이오 기업의 홈페이지 신규 제작과 리뉴얼 사례, 작업 범위와 성과를 확인하세요.',
  },
  '/about': {
    path: '/about',
    ...
    description:
      '기획부터 디자인, 개발, 데이터 이전, 운영까지 직접 수행하는 기업 홈페이지 전문 에이전시 websLAB을 소개합니다.',
  },
} as const;
